...
export const Links: FC = () => {
	return <div className={styles.linkBox}>
		...
		} linkPath={PATHS.MY_MAIN} itemsCount={4} />

		<HeaderLink title={'Заказы'} svg={<svg width={24} height={24}>
			<path fill='currentColor'
		...
		</svg>} linkPath={PATHS.MY_ORDER_LIST} itemsCount={10} />

		<HeaderLink title={'Избранное'} svg={<svg width={24} height={24}>
			<path fill='currentColor'
		...
		</svg>} linkPath={PATHS.MY_FAVORITES} itemsCount={3} />

		<HeaderLink title={'Корзина'} svg={<svg width={24} height={24}>
			<path
				fill='currentColor'
			...
			></path>
		</svg>} linkPath={PATHS.CART} itemsCount={21} />
	</div>
}

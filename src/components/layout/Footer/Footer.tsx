				...
				<div className={styles.jobBox}>
					<Link className={styles.logo} href={PATHS.HOME}>
						<Image
							...
							height={23}
							alt={'Ozon Job'}
							src={'https://ir.ozone.ru/s3/cms/12/tdb/group_357672.png'}
						/>
					</Link>
					...
					<div className={styles.infoBoxRightSide}>
						<div className={styles.links}>
							<div className={styles.linksList}>
								...
								{footerLinksOne.links.map((l) => (
									<Link className={styles.link} key={l.title} href={l.link}>
										{l.title}
									</Link>
								))}
							</div>

...
export const selectionItemsArray: IProduct[] = [
	...
	{ price: 12300, title: 'fldmfkmfk fd,fmdkfod [dkfdf dflkdf m4444444444kfms', category: 'd;l;fmdlf', discount: 49 },
	{
		price: 101500,
	...
	{ price: 10, title: 'fldmfkmfk ldfdf ddf,df dfdfdfm5555555555kfms', category: 'd;l;fmdlf', discount: 71 },
]
